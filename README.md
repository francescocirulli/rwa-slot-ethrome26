...
| [`arduino`](arduino) | UNO R4 WiFi firmware, local WebSocket bridge and cabinet setup |
...
local Node bridge and the same HTTPS backend. The iPad provides audio and an
