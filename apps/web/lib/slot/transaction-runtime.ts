import {adminWrites} from '../admin/write-coordinator';
...
export function getContractApi() {
  return global.slotContractApi ||= createContractApi({getSlot:getSlotEngine,coordinator:adminWrites(),admin:getAdminRuntime().service,
