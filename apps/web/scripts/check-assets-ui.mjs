...
const inventory={address:wallet,contract:null,eth:'0.01',block:'123',updatedAt:Date.now(),swapEnabled:true,assets,nfts:[{symbol:0,name:'Magnet'},{symbol:3,name:'Hopera'},{symbol:8,name:'ENS Registration'},{symbol:9,name:'Urbe Hub Day Pass'},{symbol:10,name:'T-shirt'}].map(n=>({...n,token:null,tokenId:null,balance:null})),freeSpins:null};
